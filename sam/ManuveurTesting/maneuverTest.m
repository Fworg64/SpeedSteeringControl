...
%the solution is almost done, just need to add cases for running the one
%turn solver in reverse and running the one turn solver when a J hook is to
%be run. Also special cases like straight line and destinations which are
