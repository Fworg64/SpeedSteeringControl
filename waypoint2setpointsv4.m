...
function [firstdistance, firstradius, seconddistance, secondradius, xcenter, ycenter, xcenter2, ycenter2] = waypoint2setpointsv4(x1, y1, theta)
...
if ( (y1>0 && theta<=0)||(y1<0 & theta>=0)||( distancetostartsq < .01) )
...
%Single Arc
elseif (xintercept>=0 && ( (y1 >0 &&theta >0 && theta <pi) || (y1<0 && theta <0 && theta > -pi) )) %if x intercept is greater than 0 and final orientation is facing away from starting center line
